  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-2xl mx-auto py-6 sm:py-8 px-4 sm:px-6">
        <Link to="/" className="inline-flex items-center text-blue-600 hover:underline text-sm mb-4">
        ...
        <h1 className="text-2xl sm:text-3xl font-bold mb-2">Report a Bug</h1>
        <p className="text-gray-600 mb-6">Found something wrong? Let us know and we'll fix it.</p>

        {success ? (
          <div className="bg-white p-8 rounded-lg shadow-sm text-center">
            <div className="text-4xl mb-4">✅</div>
            <h2 className="text-xl font-semibold mb-2">Thank you!</h2>
            <p className="text-gray-600 mb-4">Your bug report has been submitted. We'll look into it and fix it.</p>
          ...
          <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-sm border border-gray-100 space-y-4">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full px-6 py-2.5 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-medium disabled:opacity-50"
            >
