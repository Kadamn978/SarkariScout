          ...
          <div className="p-6 sm:p-10 space-y-8 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">1. The deal</h2>
               <p>Use RozgarScout and you're agreeing to these terms. Don't use it if you don't agree — that's fair. We can update these terms whenever we need to, and if you keep using the site after we do, that counts as accepting the changes.</p>
            </section>

            <section>
               <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">2. What RozgarScout actually does</h2>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">7. No guarantees</h2>
               <p>RozgarScout runs on a "best efforts" basis. We work hard to keep things accurate and running, but we can't promise perfection.</p>
            ...
            <section>
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-3">8. Our liability has limits</h2>
               <p>To the extent the law allows, RozgarScout won't be responsible for:</p>
              <ul className="list-disc pl-5 space-y-1.5 mt-2">
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 pt-6 mt-8">
               <p className="text-xs text-gray-500 dark:text-gray-400">By using RozgarScout, you've read these terms, understood them, and agreed to follow them. If you don't agree, don't use the site.</p>
            </div>
