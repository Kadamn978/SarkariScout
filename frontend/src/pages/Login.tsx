  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-950 px-4">
      <main className="w-full max-w-md p-6 sm:p-8 bg-white dark:bg-gray-900 rounded-lg shadow dark:shadow-gray-800" role="main">
        <h1 className="text-2xl font-bold text-center mb-6 text-gray-900 dark:text-white">Login to SarkariScout</h1>
        ...
        <p className="text-center mt-6 text-sm text-gray-600 dark:text-gray-400">
          Don&apos;t have an account? <Link to="/register" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">Register</Link>
        </p>
      </main>
    </div>
  )
