    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 sm:py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <h2 className="text-2xl sm:text-3xl font-bold text-center text-gray-900 mb-2">Trusted by Aspirants</h2>
          <p className="text-center text-gray-500 mb-10">Here is what our users say</p>
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              { name: 'Rahul K.', exam: 'SSC CGL 2025', text: 'Got my admit card date alert just in time. Would have missed the SSC CGL deadline without SarkariScout.' },
              { name: 'Priya M.', exam: 'IBPS PO', text: 'The mock tests helped me crack IBPS PO. The practice papers are exactly like the real exam pattern.' },
              { name: 'Amit S.', exam: 'UPSC Prelims', text: 'Best platform for government job prep. Daily digests keep me updated without checking 10 different websites.' },
            ].map((t, i) => (
