    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-3xl mx-auto py-8 sm:py-12 px-4 sm:px-6">
        <nav className="flex items-center gap-1.5 text-sm text-gray-500 mb-6" aria-label="Breadcrumb">
          <Link to="/" className="hover:text-blue-600">Home</Link><span>/</span><span className="text-gray-900">Contact</span>
        </nav>

        <h1 className="text-3xl font-bold text-gray-900 mb-2">Contact Us</h1>
        <p className="text-gray-500 mb-8">Have a question, suggestion, or need help? We would love to hear from you.</p>

        <div className="grid sm:grid-cols-2 gap-8">
          <div className="space-y-6">
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              <h3 className="font-semibold text-gray-900 mb-2">Email</h3>
              <p className="text-sm text-gray-600 mb-3">For general inquiries, bug reports, or feedback:</p>
              <a href="mailto:support@sarkariscout.in" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-100">
              ...
              <p className="text-sm text-gray-600 mb-3">Found a bug or issue? Use our dedicated bug report form for faster tracking.</p>
              <Link to="/bug-report" className="text-blue-600 hover:text-blue-700 font-medium text-sm">
                Report a Bug →
              </Link>
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-100">
            {submitted ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-500 text-sm">Thank you for reaching out. We will get back to you within 24-48 hours.</p>
              </div>
            ) : (
