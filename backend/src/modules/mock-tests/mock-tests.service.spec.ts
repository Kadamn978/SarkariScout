...
describe('MockTestsService', () => {
  ...
  beforeEach(async () => {
    ...
    const module: TestingModule = await Test.createTestingModule({
      providers: [MockTestsService, { provide: PrismaService, useValue: prisma }],
    }).compile()
  ...
  describe('findAll', () => {
    ...
    it('should cap limit at 50', async () => {
      ...
      expect(prisma.mockTest.findMany).toHaveBeenCalledWith(expect.objectContaining({ take: 50 }))
    })
  })
  ...
  describe('submitAttempt', () => {
    ...
    it('should throw NotFoundException when attempt not found', async () => {
      ...
      await expect(service.submitAttempt('u1', 'nonexistent', {}, 0)).rejects.toThrow(
        NotFoundException,
      )
    })
  ...
  describe('startAttempt', () => {
    it('should create a new attempt if none exists', async () => {
      ...
      prisma.mockTestAttempt.create.mockResolvedValue({
        id: 'a1',
        testId: 'mt1',
        userId: 'u1',
        score: null,
