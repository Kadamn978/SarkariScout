...
describe('AnalyticsService', () => {
  ...
  describe('trackPageView', () => {
    ...
    it('should parse mobile device from userAgent', async () => {
      ...
      await service.trackPageView({
        path: '/jobs',
        userAgent:
          'Mozilla/5.0 (iPhone; CPU iPhone OS 16_0) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.0 Mobile/15E148 Safari/604.1',
      })
  ...
  describe('getDashboardStats', () => {
    ...
    it('should use custom days parameter', async () => {
      ...
      prisma.$queryRaw.mockResolvedValue([]).mockResolvedValue([]).mockResolvedValue([])
