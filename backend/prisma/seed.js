    ...
    const jobs = [
        {
            ...
            totalVacancies: 18000, state: 'ALL_IN', category: 'GOVERNMENT',
            ...
            status: 'OPEN', applyUrl: 'https://ssc.gov.in/apply',
        ...
        },
        {
            ...
            totalVacancies: 1100, state: 'ALL_IN', category: 'GOVERNMENT',
            ...
            examDate: new Date('2026-06-01'), status: 'OPEN',
        ...
        },
        {
            ...
            totalVacancies: 600, state: 'ALL_IN', category: 'ENGINEERING',
            ...
            examDate: new Date('2027-01-10'), status: 'OPEN',
            applyUrl: 'https://upsconline.nic.in',
        },
        {
            ...
            totalVacancies: 400, state: 'ALL_IN', category: 'DEFENCE',
            ...
            examDate: new Date('2026-09-07'), status: 'OPEN',
            applyUrl: 'https://upsconline.nic.in',
        },
        {
            ...
            totalVacancies: 4000, state: 'ALL_IN', category: 'BANKING',
            ...
            status: 'OPEN', applyUrl: 'https://ibps.in/careers',
        ...
        },
        {
            ...
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-09-30'),
            status: 'OPEN', applyUrl: 'https://sbi.co.in/careers',
        },
        {
        ...
        },
        {
            ...
            totalVacancies: 300, state: 'ALL_IN', category: 'BANKING',
            ...
            examDate: new Date('2026-12-01'), status: 'OPEN',
        ...
        },
        {
            ...
            totalVacancies: 35000, state: 'ALL_IN', category: 'RAILWAY',
            qualificationText: 'Graduate from recognized university', qualificationLevels: JSON.stringify(['Graduate']),
        ...
        },
        {
            ...
            totalVacancies: 15000, state: 'ALL_IN', category: 'RAILWAY',
            ...
            examDate: new Date('2026-12-20'), status: 'OPEN',
            applyUrl: 'https://rrbapply.gov.in',
        },
        {
            ...
            totalVacancies: 32000, state: 'ALL_IN', category: 'RAILWAY',
            ...
            status: 'OPEN', applyUrl: 'https://rrbapply.gov.in',
        },
        {
            ...
            totalVacancies: 300, state: 'ALL_IN', category: 'PSU',
            ...
            examDate: new Date('2027-02-15'), status: 'OPEN',
        ...
        },
        {
            ...
            totalVacancies: 200, state: 'ALL_IN', category: 'PSU',
            ...
            applyStart: new Date('2026-09-15'), applyEnd: new Date('2026-10-15'),
            status: 'OPEN', applyUrl: 'https://ntpc.co.in/careers',
        },
        {
            ...
            totalVacancies: 150, state: 'ALL_IN', category: 'IT',
            ...
            status: 'OPEN', applyUrl: 'https://cdac.in/index.aspx',
        },
        {
            ...
            totalVacancies: 100, state: 'Karnataka', category: 'PSU',
            ...
            applyStart: new Date('2026-08-01'), applyEnd: new Date('2026-08-31'),
            status: 'OPEN', applyUrl: 'https://bel-india.in',
        },
        {
        ...
        },
        {
            ...
            totalVacancies: 40, state: 'ALL_IN', category: 'DEFENCE',
            ...
            status: 'OPEN', applyUrl: 'https://joinindianarmy.nic.in',
        },
        {
            ...
            totalVacancies: 2500, state: 'ALL_IN', category: 'DEFENCE',
            ...
            examDate: new Date('2026-11-01'), status: 'OPEN',
        ...
        },
        {
            ...
            totalVacancies: 3000, state: 'ALL_IN', category: 'DEFENCE',
            ...
            status: 'OPEN', applyUrl: 'https://agnipathvayu.cdac.in',
        },
        {
        ...
        },
        {
            ...
            totalVacancies: 5000, state: 'Maharashtra', category: 'POLICE',
            ...
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-15'),
            examDate: new Date('2027-01-20'), status: 'OPEN',
        ...
        },
        {
            ...
            totalVacancies: 5000, state: 'Delhi', category: 'POLICE',
            qualificationText: '12th Pass from recognized board', qualificationLevels: JSON.stringify(['12th Pass']),
            ageMin: 18, ageMax: 25, generalFee: 100, obcFee: 100, scStFee: 0,
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://delhipolice.gov.in',
        },
        {
            ...
            totalVacancies: 200, state: 'Maharashtra', category: 'GOVERNMENT',
        ...
        },
        {
            ...
            totalVacancies: 600, state: 'Maharashtra', category: 'POLICE',
            qualificationText: 'Graduate from recognized university', qualificationLevels: JSON.stringify(['Graduate']),
            ageMin: 18, ageMax: 38, generalFee: 500, obcFee: 500, scStFee: 250,
            applyStart: new Date('2026-08-15'), applyEnd: new Date('2026-09-15'),
            status: 'OPEN', applyUrl: 'https://mpsc.gov.in',
        },
        {
            ...
            totalVacancies: 400, state: 'Maharashtra', category: 'GOVERNMENT',
            qualificationText: 'Graduate from recognized university', qualificationLevels: JSON.stringify(['Graduate']),
            ageMin: 21, ageMax: 38, generalFee: 500, obcFee: 500, scStFee: 250,
            applyStart: new Date('2026-08-01'), applyEnd: new Date('2026-08-31'),
            examDate: new Date('2026-11-15'), status: 'OPEN',
            applyUrl: 'https://mpsc.gov.in',
        },
        {
            ...
            totalVacancies: 2500, state: 'Bihar', category: 'POLICE',
            qualificationText: 'Graduate from recognized university', qualificationLevels: JSON.stringify(['Graduate']),
            ageMin: 18, ageMax: 25, generalFee: 700, obcFee: 700, scStFee: 200,
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://bpsc.bih.nic.in',
        },
        {
            ...
            totalVacancies: 350, state: 'Madhya Pradesh', category: 'GOVERNMENT',
            qualificationText: 'Graduate from recognized university', qualificationLevels: JSON.stringify(['Graduate']),
            ageMin: 21, ageMax: 40, generalFee: 500, obcFee: 500, scStFee: 250,
            applyStart: new Date('2026-09-15'), applyEnd: new Date('2026-10-15'),
            status: 'OPEN', applyUrl: 'https://mppsc.mp.gov.in',
        },
        {
            ...
            totalVacancies: 500, state: 'Tamil Nadu', category: 'GOVERNMENT',
            ...
            status: 'OPEN', applyUrl: 'https://tnpsc.gov.in',
        },
        {
            ...
            totalVacancies: 1200, state: 'Karnataka', category: 'GOVERNMENT',
            ...
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://kpsc.kar.nic.in',
        },
        {
            ...
            totalVacancies: 450, state: 'West Bengal', category: 'GOVERNMENT',
            qualificationText: 'Graduate from recognized university', qualificationLevels: JSON.stringify(['Graduate']),
            ageMin: 21, ageMax: 36, generalFee: 210, obcFee: 210, scStFee: 0,
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://wbpsc.gov.in',
        },
        {
            ...
            totalVacancies: 300, state: 'ALL_IN', category: 'ENGINEERING',
            ...
            applyStart: new Date('2026-08-15'), applyEnd: new Date('2026-09-15'),
            status: 'OPEN', applyUrl: 'https://www.isro.gov.in/careers',
        },
        {
            ...
            totalVacancies: 200, state: 'ALL_IN', category: 'ENGINEERING',
            ...
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://drdo.gov.in/careers',
        },
        {
            ...
            totalVacancies: 100, state: 'ALL_IN', category: 'ENGINEERING',
            ...
            applyStart: new Date('2026-09-15'), applyEnd: new Date('2026-10-15'),
            status: 'OPEN', applyUrl: 'https://nhai.gov.in',
        },
        {
            ...
            totalVacancies: 25000, state: 'ALL_IN', category: 'GOVERNMENT',
            qualificationText: '12th Pass from recognized board', qualificationLevels: JSON.stringify(['12th Pass']),
            ageMin: 18, ageMax: 27, generalFee: 100, obcFee: 100, scStFee: 0,
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            examDate: new Date('2026-12-15'), status: 'OPEN',
        ...
        },
        {
            ...
            totalVacancies: 3000, state: 'ALL_IN', category: 'GOVERNMENT',
            qualificationText: '12th Pass from recognized board', qualificationLevels: JSON.stringify(['12th Pass']),
            ageMin: 18, ageMax: 27, generalFee: 100, obcFee: 100, scStFee: 0,
            applyStart: new Date('2026-10-01'), applyEnd: new Date('2026-10-31'),
            status: 'OPEN', applyUrl: 'https://ssc.gov.in',
        },
        {
            ...
            totalVacancies: 2000, state: 'ALL_IN', category: 'ENGINEERING',
            qualificationText: 'Diploma/B.E. in relevant engineering discipline', qualificationLevels: JSON.stringify(['Diploma', 'Engineering']),
            ageMin: 18, ageMax: 32, generalFee: 100, obcFee: 100, scStFee: 0,
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://ssc.gov.in',
        },
        {
            ...
            totalVacancies: 1500, state: 'ALL_IN', category: 'TEACHING',
            ...
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://kvsangathan.nic.in',
        },
        {
            ...
            totalVacancies: 800, state: 'Delhi', category: 'TEACHING',
            qualificationText: 'PG + B.Ed for PGT, Grad + B.Ed for TGT', qualificationLevels: JSON.stringify(['Graduate', 'Post Graduate']),
            ageMin: 18, ageMax: 35, generalFee: 100, obcFee: 100, scStFee: 0,
            applyStart: new Date('2026-08-01'), applyEnd: new Date('2026-09-01'),
            status: 'OPEN', applyUrl: 'https://dsssb.delhi.gov.in',
        },
        {
            ...
            totalVacancies: 2000, state: 'ALL_IN', category: 'MEDICAL',
            ...
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://aiimsexams.ac.in',
        },
        {
            ...
            totalVacancies: 1000, state: 'ALL_IN', category: 'MEDICAL',
            ...
            applyStart: new Date('2026-08-15'), applyEnd: new Date('2026-09-15'),
            status: 'OPEN', applyUrl: 'https://esic.nic.in',
        },
        {
        ...
        },
        {
            ...
            totalVacancies: 200, state: 'ALL_IN', category: 'INTERNSHIP',
            ...
            ageMin: 18, ageMax: 25, generalFee: 0, obcFee: 0, scStFee: 0,
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-09-30'),
            status: 'OPEN', applyUrl: 'https://apprenticeshipindia.gov.in',
        },
        {
            ...
            totalVacancies: 300, state: 'ALL_IN', category: 'INTERNSHIP',
        ...
        },
        {
            ...
            totalVacancies: 5000, state: 'ALL_IN', category: 'DEFENCE',
            qualificationText: 'Graduate from recognized university', qualificationLevels: JSON.stringify(['Graduate']),
        ...
        },
        {
            ...
            postNames: JSON.stringify(['Trade Apprentice', 'Graduate Apprentice']),
            totalVacancies: 5000, state: 'ALL_IN', category: 'RAILWAY',
            ...
            applyStart: new Date('2026-08-01'), applyEnd: new Date('2026-09-01'),
            status: 'OPEN', applyUrl: 'https://rrc.indianrailways.gov.in',
        },
        {
            ...
            totalVacancies: 50, state: 'ALL_IN', category: 'TEACHING',
            ...
            applyStart: new Date('2026-09-01'), applyEnd: new Date('2026-10-01'),
            status: 'OPEN', applyUrl: 'https://niituniversity.in',
        },
    ];
